...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("║       Armature DI + Lifecycle Hooks + Diesel               ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");
    ...
    println!("🔌 Injecting DieselDatabaseService into UserService...");
    ...
    println!("📝 Creating test users using Diesel's type-safe query builder...");
    match user_service
    ...
    // List users
    println!("📋 Listing all users with Diesel query...");
    ...
    println!("\n═══════════════════════════════════════════════════════════════");
    println!("✅ Diesel ORM integration example complete!");
    println!("═══════════════════════════════════════════════════════════════\n");

    println!("🎯 Key Features Demonstrated:");
    println!("   ✅ Diesel's type-safe query builder");
    println!("   ✅ R2D2 connection pooling");
    println!("   ✅ Lifecycle hook integration");
    println!("   ✅ Dependency injection");
    println!("   ✅ Compile-time SQL verification");
    println!();
