...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║         SeaORM Integration Example                         ║");
    println!("║       Armature DI + Lifecycle Hooks + SeaORM               ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");
    ...
    println!("🔌 Injecting SeaOrmDatabaseService into UserService...");
    ...
    println!("📝 Creating test users using SeaORM's async API...");
    match user_service
    ...
    // List users
    println!("📋 Listing all users with SeaORM async query...");
    ...
    // Search feature
    println!("🔍 Searching users with 'sea' in username...");
    ...
    println!("\n═══════════════════════════════════════════════════════════════");
    println!("✅ SeaORM integration example complete!");
    println!("═══════════════════════════════════════════════════════════════\n");

    println!("🎯 Key Features Demonstrated:");
    println!("   ✅ SeaORM's async-first API");
    println!("   ✅ Modern Rust patterns");
    println!("   ✅ Entity-based models");
    println!("   ✅ ActiveModel pattern");
    println!("   ✅ Advanced query features");
    println!();
